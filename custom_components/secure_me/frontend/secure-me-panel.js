...
import { ICONS, icon } from "./secure-me-panel-shared.js";
import { FloorplanMixin } from "./secure-me-panel-floorplan.js";
...
class SecureMePanelCore extends HTMLElement {
  constructor() {
    super();
...
// === Compose mixins onto the core class ===
// Pilot (2026-08-29): FloorplanMixin is the first slice extracted from the
// monolithic class as an ES module -- see secure-me-panel-floorplan.js.
class SecureMePanel extends FloorplanMixin(SecureMePanelCore) {}
