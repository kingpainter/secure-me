...
class SecureMeStore:
    ...
    def _default_auto_actions() -> dict:
        ...
        return {
            ...
            AA_RECHECK_INCLUDE_LOCK: DEFAULT_AA_RECHECK_INCLUDE_LOCK,
            AA_RECHECK_INCLUDE_ALARM: DEFAULT_AA_RECHECK_INCLUDE_ALARM,
            AA_RECHECK_INCLUDE_CAMERA: DEFAULT_AA_RECHECK_INCLUDE_CAMERA,
